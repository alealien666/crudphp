...
<body>
  ...
  <!-- akhir navbar -->
  <h2 style="margin-left: 35%;">SILAHKAN MENGISI DATA</h2>
  <div class="pitik">
    <form action="ptambah.php" method="post">

      <label>NAMA BARANG</label><br>
      <input type="text" name="barang" class="input">
      <br>
      <br>
      <label>WARNA</label><br>
      <input type="text" name="wr" class="input">
      <br>
      <br>
      <label>STOK</label><br>
      <input type="text" name="stk" class="input">
      <br><br>
      <button type="submit" class="bton">TAMBAH</button>
    </form>
  </div>
  <footer>
